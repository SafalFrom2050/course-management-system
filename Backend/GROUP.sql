...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2021 at 04:12 PM
...
(7, 2004, '2020-03-02 09:13:46', 4, 0, 5, 'Lecture'),
...
CREATE TABLE `routines` (
  ...
  `second_module_name` varchar(255) NOT NULL,
  `second_start_time` varchar(10) NOT NULL,
  `second_end_time` varchar(10) NOT NULL,
  `semester` int(5) NOT NULL,
  `class_type_1` varchar(15) NOT NULL,
  `class_type_2` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `routines` (`routine_id`, `course_id`, `day_number`, `day`, `module_id`, `start_time`, `end_time`, `second_module_name`, `second_start_time`, `second_end_time`, `semester`, `class_type_1`, `class_type_2`) VALUES
(1, 101, 1, 'Sunday', 2002, '6:30 AM', '8:30 AM', 'Formal Specification of Software Systems 1', '9:00 AM', '11:00 AM', 4, 'Lecture', 'Lecture'),
(2, 101, 2, 'Monday', 2005, '6:30 AM', '8:30 AM', 'Group Project and Project Management', '9:00 AM', '11:00 AM', 4, 'Lecture', 'Lecture'),
(3, 101, 1, 'Sunday', 1001, '6:30 AM', '8:30 AM', 'Problem Solving And Programming', '9:00 AM', '11:00 AM', 1, 'Lecture', 'Tutorial');
...
--
ALTER TABLE `attendancemodules`
  MODIFY `attendance_modules_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `attendances`
--
ALTER TABLE `attendances`
  MODIFY `attendance_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
ALTER TABLE `routines`
  ...
  ADD CONSTRAINT `fk_m1_modules` FOREIGN KEY (`module_id`) REFERENCES `modules` (`module_id`);
